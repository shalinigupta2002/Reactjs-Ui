...
scrollYProgress.on("change",(data) => {
  function imagesShow(arr){
    setImages((prev) =>
      (prev.map((item,index) =>arr.indexOf(index) === -1 ? {...item , isActive:false} :
      {...item, isActive:true}
    )
      ))
  }
  ...
  return (
    ...
    <div className='relative max-w-screen-xl mx-auto text-center'>
        <h1 className='text-[30vw] leading-none font-normal select-none -tracking-10 '>work</h1>
        <h1 className="text-gray-500">Web Design, Webflow Development, Creative Development </h1>
    </div>
